...
- [ ] **F7.6** — Home por secciones (componentes) idéntica al prototipo, con textos listos para reescribir (F9.1). Verificar: diff visual con capturas de 1440 y 400 px. **En curso, primera tanda hecha:** las 27 secciones del prototipo ya están en la página con su contenido real —títulos, párrafos con su énfasis, listas, 33 fotos, 20 preguntas del FAQ y los CTA—, extraído por `scripts/extract-home.mjs` en vez de transcrito a mano. **Falta** que cada sección recupere su composición propia del prototipo (tarjetas de zona, tarjetas de vehículo, carrusel de reseñas, rejilla de servicios): hoy todas pasan por un mismo diseño genérico. El cotizador del primer bloque es F8 y el hero con video, F7.7.
